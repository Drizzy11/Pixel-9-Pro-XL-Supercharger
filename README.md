...
Visit the [project website](https://drizzy07x.github.io/Supercharger_Pixel_9_Series/) for the English/Spanish guide, version history, requirements checker, ZIP verification, and support draft tools.
See [website development](docs/WEBSITE.md) for local preview and publishing.
